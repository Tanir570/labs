...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("emages/coin.png")
...
while True:
    ...
    coin_collected = pygame.sprite.spritecollideany(PLayer1, coins)
    if coin_collected:
        coins.remove(coin_collected)
        allsprites.remove(coin_collected)  # Remove the collected coin from all_sprites group
        SCORE += 1         
